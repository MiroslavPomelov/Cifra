...
function Example() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const StudentRepository = AppDataSource_1.AppDataSource.getRepository(Student_1.Student);
        const TeacherRepository = AppDataSource_1.AppDataSource.getRepository(Teacher_1.Teacher);
        let historyTeacher = new Teacher_1.Teacher();
        historyTeacher.firstname = 'Bogdan';
        historyTeacher.lastname = 'Black';
        historyTeacher.age = 25;
        historyTeacher.students = [];
        let designTeacher = new Teacher_1.Teacher();
        designTeacher.firstname = 'Anton';
        designTeacher.lastname = 'White';
        designTeacher.age = 28;
        designTeacher.students = [];
        let mathTeacher = new Teacher_1.Teacher();
        ...
        yield TeacherRepository.save([historyTeacher, mathTeacher, designTeacher]);
        yield StudentRepository.save([student1, student2, student3, student4, student5, student6, student7, student8, student9, student10, student11, student12, student13, student14, student15]);
        //Считать
        const foundStudents = yield StudentRepository.find({
            where: {
                id: 2
            }
        });
