namespace _20._10._2023Redaction
{
    partial class RegistrationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // RegistrateBTN
            // 
            RegistrateBTN.Location = new Point(60, 332);
            ...
            AuthorCB.Location = new Point(12, 308);
            AuthorCB.Margin = new Padding(3, 2, 3, 2);
            AuthorCB.Name = "AuthorCB";
            AuthorCB.Size = new Size(59, 19);
            AuthorCB.TabIndex = 14;
            AuthorCB.Text = "Автор";
            AuthorCB.UseVisualStyleBackColor = true;
            AuthorCB.CheckedChanged += AuthorCB_CheckedChanged;
            // 
            // ReaderCB
            // 
            ReaderCB.AutoSize = true;
            ReaderCB.Location = new Point(180, 308);
            ReaderCB.Margin = new Padding(3, 2, 3, 2);
            ...
            ReaderCB.CheckedChanged += ReaderCB_CheckedChanged;
            // 
            // RegistrationForm
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(276, 399);
