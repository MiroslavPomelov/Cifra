namespace list
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //DateTime dateTime2 = new DateTime(2016, 6, 15, 12, 45, 25);
            ...
            ////f - полный формат даты и карткий времени
            ////G - краткий формат даты и полный времени
            ////g - краткий формат даты и времени
            ////M - формат дней месяца
            ////O - Формат обратного преобразования даты и времени
            ////R - Время по Гринвичу
            ////s - сортируемый формат даты и времни
            ...
            double sum = ((hours / (24.0 / 6) * count * pay) + ((hours / (24.0 / 10) * count * pay * 0, 7) + ((hours / (24.0 / 6) * count * pay * 0, 4));
